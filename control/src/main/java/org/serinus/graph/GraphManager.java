...
public class GraphManager
{
	...
	if (repositoryJboss != null) {
	    graphDatabaseService = new EmbeddedGraphDatabase(repositoryJboss + "/serinus-graph");
	    logger.info("Graph database in " + repositoryJboss);
	...
	return indexManager.forNodes("serinus", MapUtil.stringMap(IndexManager.PROVIDER, "lucene", "type", "fulltext"));
